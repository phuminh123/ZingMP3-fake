var listSong = [
    ...
    [{
        ...
        },
        {
            name: "2002",
            singer: ["Anne-Marie"],
            path: "./assets/music/listSong3/song17.mp3",
            image: "./assets/img/music/listSong3/song17.jpg"
        },
        {
            name: "Close To The Sun",
            singer: ["The Fat Rat"],
            path: "./assets/music/listSong5/song1.mp3",
            image: "./assets/img/music/listSong5/song1.jpg"
        },
        {
            name: "Fly Away",
            singer: ["The Fat Rat"],
            path: "./assets/music/listSong5/song2.mp3",
            image: "./assets/img/music/listSong5/song2.jpg"
        },
        {
            name: "We'll Meet Again",
            singer: ["The Fat Rat"],
            path: "./assets/music/listSong5/song3.mp3",
            image: "./assets/img/music/listSong5/song3.jpg"
        },
        {
            name: "Monody",
            singer: ["The Fat Rat"],
            path: "./assets/music/listSong5/song4.mp3",
            image: "./assets/img/music/listSong5/song4.jpg"
        },
    ],
    [{
            name: "Eyes - Đôi mắt",
